...
Hart Montgomery asked Kieran to talk about the base line security aspects incorporating open SSF badging etc. Kieran mentioned that they are collaborating with Open SSF community for base line security.  
McDermott mentioned as they receive feedback from the community, they incorporate them in the next releases.

---

## **PQCA calendar issue \- Nigel Jones**

Nigel Jones mentioned that in the PQCA calendar there is a pending issue. Basically, old google calendar (subscribe) is not working. Jones explained that iCAL (blue button) works. He asked LF to remove the “you can also subscribe to the google calendar” and instead add “click iCAL” button.

**Action**  \- Ethirajulu took the action to fix this.
...
- Brian mentioned that TSC teams can plan for their blogs in their meetings and plan for this. We will add all the planned blogs in the excel sheet.   
