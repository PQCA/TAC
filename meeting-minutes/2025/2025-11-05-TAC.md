...
- Growth Plan: Hart gave us an overview of how a growth plan should look like during the 2025-10-02 TSC meeting - thanks! All sub projects are now preparing their own growth plan - we are collecting it in [pq-code-package/tsc#188](https://github.com/pq-code-package/tsc/issues/188). The mlkem-native growth plan can be found [here](https://github.com/pq-code-package/tsc/issues/188#issuecomment-3490056493).

**Sub-project updates:**

**mlkem-native**

- We finished an integration of mlkem-native into OpenTitan leverarging their Keccak (KMAC) hardware accelerator. It has been merged into zeroRISC's OpenTitan distribution: [crypto] mlkem-native integration zerorisc/expo#97. We are working on a blog post on this integration - can we post this on the PQCA blog?
- We have merged the RISC-V vector backend: Add RISCV64 RVV backend pq-code-package/mlkem-native#1037

**mldsa-native**

- We finished all initial performance work on the AArch64 and x86 backends (achieving comparable or better performance as state of the art)
Most configuration options are added
- We are working towards an v1.0.0-alpha relase: https://github.com/pq-code-package/mldsa-native/milestone/1 (Planning a release in 1-2 weeks)
