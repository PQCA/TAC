...
---
# Meeting Agenda
- CH: Cisco <> PQCA Meetup Event - February 3rd - [Register for free](https://linuxfoundation.regfox.com/cisco-pqca-pqc-meetup-event)
- CH: [Summer Mentorship Program](https://github.com/PQCA/wiki/wiki/PQCA-Mentorship-Program) - Call for Mentors - Issue Template for project proposals will be created in TAC repo
