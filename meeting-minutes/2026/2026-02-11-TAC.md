...
The team also discussed upcoming OQS release planning, including the need to update mlk-native, which is currently nine months behind the latest drops. Norman noted he will take feedback regarding increased release frequency back to the OQS team and coordinate timing for mldsa-native updates.

- PQCP
  - 
Matthias reported on several PQCP updates:
- Presentation scheduled for March 9 at RWC in Taipei, where Matthias and Hanno will present on mlk-native.
- Ongoing work on whole-light proofs and extended verification for x86 and ARM.
...
Matthias emphasized the importance of aligning mlk-native updates ahead of the RWC talk.
